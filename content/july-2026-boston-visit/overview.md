...
Friends are visiting **Wednesday July 29 through Monday August 3, 2026**. Five usable days.

**Where they sleep changes mid-trip**, and it drives the whole plan:

| Nights | Where | Effect |
|---|---|---|
| Wed, Thu, Fri | **The Westin Copley Place** -- 10 Huntington Ave, Back Bay | Days radiate from Copley. Green Line everywhere; no car. |
| Sat, Sun | **Our house, Newton Centre** | Car days and the D line |

**The party:** two parents plus kids aged **10 and 12**. The parents have been to Boston before; the kids haven't. That sets the approach -- hit the classics, but pick the *versions* of them that play for a 10- and 12-year-old rather than the standard adult rendering.
...
| Day | Us |
|---|---|
| **Wed** | No -- they settle in |
| **Thu** | Dinner only |
| **Fri** | Dinner only |
| **Sat** | All day |
| **Sun** | All day |

So **Wednesday, Thursday and Friday are self-guided days** and every route on those pages is written to be followed without us. Saturday and Sunday are group days.
...
### ⭐ The Feast of St. Agrippina di Mineo -- Thu Jul 30 to Sun Aug 2

A 100+ year old Sicilian-American street feast on **Hanover Street in the North End**. Free. It opens on their first full day and peaks on their last, which is an absurd piece of luck -- it brackets the visit with no scheduling effort. This is not a tourist product; it's the neighborhood's own thing.

| When | What |
|------|------|
| **Thu 7/30, 7:00pm** | Opening ceremony, then the **7:30pm children's procession** |
| **Sun 8/2, 12:30pm** | **Grand Procession** -- the saint carried through the streets, money pinned to the ribbons, brass bands. Closes with Mass at St. Leonard's and fireworks. |

Friday and Saturday it opens around noon with DJs and live bands -- worth a drop-in, not worth building a day around.

[!] **Confirm the dates by phone.** The official site's header reads "July 30 - Aug 2, 2026" but its day-by-day block still carries 2025's date numbers. The day-of-week pattern is internally consistent and that's what's mapped here, but the site is visibly half-updated.

### The Red Sox are away all five days

Verified: @ Athletics through Jul 30, @ Dodgers Jul 31 - Aug 2. **First home game is Tuesday Aug 4** -- the day after they fly out. There's no game to build a day around, so a Fenway tour is the only on-site option and it appears as a fallback, not a plan.
...
Ferry schedules, island facilities, Duck Tour departure locations and restaurant operating status were verified against primary sources in July 2026 -- the National Parks of Boston Harbor site, Boston Harbor City Cruises, Boston Duck Tours, and current listings. Museum hours, Duck Tour times and fares, Orchard House ticketing and Walden Pond's parking system were **not** verified and appear on the confirm list above rather than being stated as fact here.

Two things worth flagging because they'd otherwise be invisible: several restaurants that were fixtures a few years ago have closed or changed materially, and **Michelin published its first Boston guide in November 2025**. If the parents last visited before that, the city's dining conversation has shifted underneath them. Both are covered on the [restaurants page](../restaurants/).
