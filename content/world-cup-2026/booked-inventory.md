...
Everything purchased or confirmed for the 2026 FIFA World Cup trip, as of June 2, 2026.

---

## Match Tickets

4 tickets per match, 16 total.

| # | Date | Kickoff | Match | Venue | Capacity | Ticket 1 | Ticket 2 | Ticket 3 | Ticket 4 |
|---|------|---------|-------|-------|----------|----------|----------|----------|----------|
| 1 | Wed Jun 17 | 3:00 PM CT | England vs Croatia | AT&T Stadium, Arlington TX | 80,000 | Marina | Luka | Sukru | Maja |
| 2 | Tue Jun 23 | 7:00 PM ET | Panama vs Croatia | BMO Field, Toronto | ~30,000 | Sukru | Marina | Luka | Maja |
| 3 | Sat Jun 27 | 5:00 PM ET | Croatia vs Ghana | Lincoln Financial Field, Philadelphia | 69,000 | Marina | Luka | FIL | Sukru |
| 4 | Mon Jun 29 | 4:30 PM ET | Match 74 (Round of 32) | Gillette Stadium, Foxborough MA | 65,000 | TBD | TBD | TBD | TBD |

**Notes:**
- Dallas tickets 3 & 4: **NOT sold -- Sukru + Maja attending** (decision reversed Jun 2 to YOLO/all-4; see planning/09). All 4 tickets used.
- Match 74 (Gillette): deferred -- decide after group stage results
- All kickoff times shown in local venue time zone

---

## Hotels

| # | Hotel | City | Dates | Nights | Room Type | Guests | Cash Paid | Conf # | Cancel Policy |
|---|-------|------|-------|--------|-----------|--------|-----------|--------|---------------|
...
| 3 | Element Philadelphia Downtown | Philadelphia, PA | Jun 25-29 | 4 | Deluxe, 2 Queen, City view, High floor | Marina, Luka, FIL, Sukru (Sat night) | **$2,421.59** | [CONF] | Non-refundable (prepaid) |

---

## Flights

| # | Date | Route | Pax | Airline | Flight | Cash Paid | Points Used | Conf # |
|---|------|-------|-----|---------|--------|-----------|-------------|--------|
...
| 8 | Jun 29 | PHL -> BOS | Marina + Luka | JetBlue | B6 1160 9:12 AM | (incl. above) | (incl.) | [CONF] |
| 9 | Jun 15 | BOS -> DFW | Sukru + Maja | American | AA 1577 5:57 PM | **$1,621.60** | -- | [CONF] |
| 10 | Jun 18 | DFW -> BOS | Sukru + Maja | American | AA 2878 9:30 AM | (incl. above) | -- | [CONF] |
| 11 | Jun 27 | BOS -> PHL | Sukru | American | AA 3225 9:37 AM | **$553.80** | -- | [CONF] |
| 12 | Jun 28 | PHL -> BOS | Sukru | American | AA 2960 5:30 PM | (incl. above) | -- | [CONF] |
...
- [CONF] (Dallas, Sukru + Maja): Sukru 29C (out) / 30C (back), Maja 29B (out) / 30B (back)
- [CONF] (Philly, Sukru): 25D (out) / 22C (back)

**Points redemptions:**
- JetBlue TrueBlue: 68,600 pts redeemed (Philly RT). 10% back after travel via JetBlue Plus card. LA cash booking earns 6,980 pts.
- Delta SkyMiles: 72,800 miles redeemed (BOS->DFW, 2 pax). Remaining balance: ~9,680 SkyMiles.
...
| Item | Status |
|------|--------|
| Passports -- Sukru + Marina | Current |
| Passports -- Luka + Maja | Received Apr 2026 ✓ |
| Independence Hall timed tickets | Not booked (free, Recreation.gov) |
| FIFA Resale listing (2 Dallas tickets) | **Closed -- not selling; Sukru + Maja attending (Jun 2)** |

---

## Cost Summary -- What We've Spent

### Cash Paid (Family Budget)
...
| Flight: BOS<->DFW Dallas RT (Jun 15+18, Sukru + Maja, AA, conf [CONF]) | $1,621.60 |
| Flight: BOS<->PHL Philly RT (Jun 27+28, Sukru, AA, conf [CONF]) | $553.80 |
| **Total cash spent** | **$12,739.63** |

### Points/Miles Redeemed

| Program | Points Used | For | Remaining Balance |
|---------|-----------|-----|-------------------|
| JetBlue TrueBlue | 68,600 pts | Philly RT (BOS<->PHL) | ~14,134 pts |
