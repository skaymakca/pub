...
We have **4 tickets to each of 4 FIFA World Cup 2026 matches** (16 tickets total). Three are Croatia group stage games; the fourth is a Round of 32 knockout match at our home stadium.

### Our Matches

| # | Date | Match | City | Venue | Kickoff (ET) |
|---|------|-------|------|-------|-------------|
...
| Game | Date | City | Attendees | Notes |
|------|------|------|-----------|-------|
...
Jun 19 (Fri)  Option: All 4 BOS → YYZ (5 nights Toronto — Porter $137/pp 10:05 AM)
              ⚠️ M+L have only ~18h recovery after Dallas
Jun 20 (Sat)  Option: All 4 BOS → YYZ (4 nights Toronto — Porter $137/pp 6:35 PM)
              Full recovery day for M+L
...
**Jun 19 vs Jun 20:** Flights are identical ($137/pp both days). Jun 19 adds ~$550 (hotel + meals) for 1 extra Toronto day. Jun 19 gives 4 full days (Niagara feasible); Jun 20 gives 3 full days. Tradeoff: M+L recovery time.
...
- Arrive at each city at least 2 nights before the game (night before the day before)
- Arrive PHL close to FIL's flight so they can go to hotel together
- Leave the day after each game
...
| Date | What |
|------|------|
| **Apr 2** | FIFA Resale Marketplace reopens — list Dallas tickets (2 or 4) |
| **Late Apr** | Book flights + hotels for all legs |
| **Jun 15** | Travel begins — BOS → DFW |
| **Jun 17** | Game 1: England vs. Croatia (Dallas) |
| **Jun 18** | DFW → YYZ |
| **Jun 18** | M+L fly DFW→BOS (Scenario B — return home) |
| **Jun 19 or 20** | All 4 fly BOS→YYZ (Scenario B — everyone to Toronto together) |
...
| **Jun 29** | Everyone departs Philadelphia — M+L: PHL → BOS; FIL: PHL → LAX; BIL: EWR → ZAG |
| **Jun 29** | Game 4: Match 74 at Gillette (ignoring for now) |

---

## Still TODO

- [ ] **Decide: Scenario A or B** — does Sukru + Maja go to Dallas?
- [ ] Book flights for all legs (see [11 — Cost Analysis](../cost-analysis/))
- [ ] Book Marriott Bonvoy hotels in Dallas, Toronto, and Philadelphia
- [ ] List 2 (or 4) Dallas tickets on FIFA Resale Marketplace on April 2
- [ ] Check passport status for all family members (needed for Toronto)
- [ ] Coordinate FIL (LAX→PHL) arrival time with Marina's YYZ→PHL flight
- [ ] Book BIL's flight via EWR (check United SPU→EWR first, then Lufthansa ZAD→hub→EWR)
